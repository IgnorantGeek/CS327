...
{
  const character_t *const *c1 = (character_t* *const) v1;
  const character_t *const *c2 = (character_t* *const) v2;
...
/* This is where the check for visibility will go
 * What will I need? A way to figure out if a part of the map
 * has been "discovered" so to speak. Same room, display whole room?
 * Radius of display area to display some of the nearby corridor?
 * Maybe the room will have a variable to store if it is discovered yet. Need to think about how this
 * Will be handled
 * */
