...
int main(int argc, char *argv[])
{
  ...
  struct timeval tv;
  uint32_t i;
  uint32_t do_load, do_save, do_seed, do_image, do_save_seed, do_save_image, do_mon;
  uint32_t long_arg;
  char *save_file;
  char *load_file;
  char *pgm_file;
  ...
  do_load = do_save = do_image = do_save_seed = do_save_image = do_mon = 0;
  do_seed = 1;
 ...
 if (argc > 1) 
 {
  ...
  {
    render_dungeon(&d);
    //for every character in the dungeon, run its move
    process_move(&d, &d.pc);
    int i;
    for (i = 0; i < d.num_mon; i++)
    {
      process_move(&d, &d.monsters[i]);
      if (position_comp(d.pc.position, d.monsters[i].position) == 0)
      {
        death = 0;
        printf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\nGame Over\n");
      }
